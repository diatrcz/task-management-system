...
namespace BOBA.Server.Migrations
{
    ...
    [Migration("20251007220432_document")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskDocTypeTaskType", b =>
                {
                    b.Property<string>("TaskDocTypesId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("TaskTypesId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("TaskDocTypesId", "TaskTypesId");

                    b.HasIndex("TaskTypesId");

                    b.ToTable("TaskDocTypeTaskType");
            ...
            modelBuilder.Entity("TaskDocTypeTaskType", b =>
                {
                    b.HasOne("BOBA.Server.Data.model.TaskDocType", null)
                        .WithMany()
                        .HasForeignKey("TaskDocTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
