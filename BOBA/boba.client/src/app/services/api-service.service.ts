...
export class TaskFlowSummaryDto implements ITaskFlowSummaryDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["taskFields"])) {
                this.taskFields = [] as any;
                for (let item of _data["taskFields"])
                    this.taskFields!.push(TaskFieldDto.fromJS(item));
            }
        }
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.taskFields)) {
            data["taskFields"] = [];
            for (let item of this.taskFields)
                data["taskFields"].push(item ? item.toJSON() : undefined as any);
        }
        return data;
    }
}
