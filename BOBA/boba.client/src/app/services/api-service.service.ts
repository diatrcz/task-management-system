...
export class ApiService {
    ...
    task_GetTaskTypes(): Observable<TaskTypeDto[]> {
        let url_ = this.baseUrl + "/api/tasktypes";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_GetTaskTypes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_GetTaskTypes(response_ as any);
                } catch (e) {
    ...
    protected processTask_GetTaskTypes(response: HttpResponseBase): Observable<TaskTypeDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    task_GetTask(taskId?: string | undefined): Observable<TaskTypeDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_GetTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_GetTask(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TaskTypeDto>;
                }
            } else
    ...
    protected processTask_GetTask(response: HttpResponseBase): Observable<TaskTypeDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    task_GetTaskFLow(taskId?: string | undefined): Observable<TaskFlowSummaryDto> {
        let url_ = this.baseUrl + "/api/taskflow?";
        if (taskId === null)
            throw new Error("The parameter 'taskId' cannot be null.");
        else if (taskId !== undefined)
            url_ += "taskId=" + encodeURIComponent("" + taskId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_GetTaskFLow(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_GetTaskFLow(response_ as any);
                } catch (e) {
    ...
    protected processTask_GetTaskFLow(response: HttpResponseBase): Observable<TaskFlowSummaryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    task_GetChoices(ids?: string[] | undefined): Observable<ChoiceSummaryDto[]> {
        let url_ = this.baseUrl + "/api/choices?";
        if (ids === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_GetChoices(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_GetChoices(response_ as any);
                } catch (e) {
    ...
    protected processTask_GetChoices(response: HttpResponseBase): Observable<ChoiceSummaryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    task_GetTaskStateName(stateId?: string | undefined): Observable<string> {
        let url_ = this.baseUrl + "/api/state-name?";
        if (stateId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_GetTaskStateName(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_GetTaskStateName(response_ as any);
                } catch (e) {
    ...
    protected processTask_GetTaskStateName(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    task_GetUserTasks(): Observable<TaskSummaryDto[]> {
        let url_ = this.baseUrl + "/api/own-tasks";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_GetUserTasks(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_GetUserTasks(response_ as any);
                } catch (e) {
    ...
    protected processTask_GetUserTasks(response: HttpResponseBase): Observable<TaskSummaryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    task_GetClosedTask(): Observable<TaskSummaryDto[]> {
        let url_ = this.baseUrl + "/api/closed-tasks";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_GetClosedTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_GetClosedTask(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TaskSummaryDto[]>;
                }
            } else
    ...
    protected processTask_GetClosedTask(response: HttpResponseBase): Observable<TaskSummaryDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    task_CreateTask(request: CreateTaskRequest): Observable<string> {
        let url_ = this.baseUrl + "/api/create-task";
        url_ = url_.replace(/[?&]$/, "");
    ...
    task_MoveTask(request: MoveTaskRequest): Observable<string> {
        let url_ = this.baseUrl + "/api/move-task";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processTask_MoveTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTask_MoveTask(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<string>;
                }
            } else
    ...
    protected processTask_MoveTask(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.nextState)) {
            ...
            for (let item of this.nextState)
                data["nextState"].push(item ? item.toJSON() : <any>undefined);
        }
